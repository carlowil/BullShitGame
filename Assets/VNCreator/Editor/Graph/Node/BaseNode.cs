    ...
    public class NodeViewer : VisualElement
    {
        ...
        public NodeViewer(BaseNode _node)
        {
            ...
            charSprDisplay.style.backgroundImage =
                node.nodeData.characterSpr ? node.nodeData.characterSpr.texture : null;
            ...
            charSprField.RegisterCallback<ChangeEvent<UnityEngine.Object>>(
                e =>
                {
                    ...
                    charSprDisplay.style.backgroundImage = node.nodeData.characterSpr
                        ? node.nodeData.characterSpr.texture
                        : null;
                }
            );
